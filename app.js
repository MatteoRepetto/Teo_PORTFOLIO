...
document.getElementById("colored_img11").addEventListener('mouseover', (event) => {
  document.getElementById("colored_img11").src = '/images/11_Robbin/00_cover2.png'
  console.log('j')
})

document.getElementById("colored__img11").addEventListener('mouseout', (event) => {
  document.getElementById("colored__img11").src = '/images/11_Robbin/00_cover.png'
